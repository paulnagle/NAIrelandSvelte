...
<article class="rounded-xl border border-[var(--border)] bg-[var(--surface-raised)] p-4 shadow-sm">
  ...
  <div class="flex flex-col gap-2">
    ...
    <!-- Share -->
    {#if canShare}
      <button type="button" onclick={shareMeeting} class="focusable flex items-center justify-center gap-2 rounded-lg border border-[var(--border)] px-4 py-2 text-sm font-semibold text-[var(--text)]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          viewBox="0 0 24 24"
