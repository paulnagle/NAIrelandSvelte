import { coordinateKey } from '$lib/geo.js';
...
export interface MeetingMarker {
  ...
  /** Ids of every meeting at this location — one for a single, many for a venue. */
  ids: string[];
}
 ...
 */
export function buildMarkers(meetings: Meeting[]): MeetingMarker[] {
